...
user_input = st.text_area(
    ...
    placeholder="예: 오늘 김할머니 점심 반 공기 드심. 기침 3번 하심. 운동 30분 함(신체상태, 정신상태 꼭 기재, !!어르신 이름 절대 적지 말 것!!)",
    height=150
)
        ...
        with st.spinner("요청하신 양식으로 변환 중입니다... "):
            try:
                ...
                if btn_official:
                    ...
                    3. 정보 부족 시 거절: 사용자의 입력이 너무 짧거나 사실관계를 알 수 없는 경우, 문장을 지어내지 말고 "어르신의 식사량, 인지 상태, 신체 상태 등에 대한 내용을 더 입력해 주세요."라고 정중히 요청하라.
