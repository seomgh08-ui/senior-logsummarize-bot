...
user_input = st.text_area(
    ...
    placeholder="예: 오늘 김할머니 점심 반 공기 드심. 기침 3번 하심. 낮잠 1시간 주무심(신체상태, 정신상태 꼭 기재!)",
    height=150
)
        ...
        with st.spinner("요청하신 양식으로 변환 중입니다... "):
            try:
                ...
                if btn_official:
                    ...
                    3. 팩트 중심: 사용자가 입력한 내용(식사, 수면, 활동 등)만 포함하고, 없는 내용을 절대 지어내지 말 것.
                    
                    [출력 포맷]
                    ■ 일일 상태 관찰 기록
                    [출력 포맷]
                    1. 식사 및 영양: (입력된 식사 관련 내용 간략히)
                    2. 신체 및 수면: (입력된 수면, 기침 등 신체 상태 간략히)
